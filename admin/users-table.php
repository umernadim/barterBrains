...
<head>
  ...
  <title>users-table | BarterBrains</title>
  <link
          ...
          <div
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
              ...
              <div class="p-0 overflow-x-auto">
                <?php
                include "../config.php";
                $sql = "SELECT id, first_name, last_name, email, profile_photo, created_at 
                      ...
                      ?>
                        <tr>
                          ...
                          <td
                            ...
                            <span
                              class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400"><?= $row['created_at']; ?></span>
                          </td>
                          <td
                            class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                            <a
                              href="delete-user.php?id=<?= urlencode($row['id']); ?>"
