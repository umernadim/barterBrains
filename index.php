    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        ...
        <div class="ms-4">
          <a
            href="signup.php"
            class="btn custom-btn custom-border-btn smoothscroll">Create Profile</a>
        </div>
      </div>
    </nav>
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            <div class="text-center mb-5 pb-2">
              ...
              <a href="login.php" class="btn custom-btn smoothscroll mt-3">Get Started</a>
            </div>
            <!-- == CAROUSEL ==-->
    ...
    <section class="featured-users">
      ...
      <div class="slider">
        <div class="slides">
           <?php 
           include "config.php";
          $sql = "SELECT r.id, u.first_name, u.last_name, u.teach_skills, u.learn_skills, u.profile_photo, r.comment 
          ...
          if (mysqli_num_rows($result) > 0) {
           ...
           ?>
               <div class="slide">
                <img src="<?= !empty($row['profile_photo']) ? 'uploads/'.$row['profile_photo'] : 'assets/profile-img.jpg' ?>" alt="User" />
                <h3><?= $row["first_name"].' '.$row["last_name"]  ?></h3>
                <p class="skills">Teaches: <?= $row["teach_skills"]; ?> | Learns: <?= $row["learn_skills"]; ?></p>
                <p class="testimonial">
                  “<?= $row["comment"]; ?>”
                </p>
              </div>
